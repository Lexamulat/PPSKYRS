...
export default class RequestReducerHelper {
    ...
    getNextState(state, action) {
        ...
        if (actionSubType.isShow())
            this._formShowState();
        else if (actionSubType.isHide())
            this._formHideState();
        else if (actionSubType.isDownloadProgress())
            this._formDownloadProgressState();
        else if (actionSubType.isUploadProgress())
            this._formUploadProgressState();
        else if (actionSubType.isCancel())
            this._formCancelState();
        else if (actionSubType.isClean())
            this._formCleanState();
        else if (actionSubType.isSuccess())
            this._formResultState();
        else if (actionSubType.isFail())
