...
import styles from './LangModDropDownList.scss';
import classNames from 'classnames';
import {Scrollbars} from 'react-custom-scrollbars';

import onClickOutside from 'react-onclickoutside';

class LangModDropDownList extends Component {
    static propTypes = {
        value: PropTypes.any,
    ...
    renderOption = (item, index) => {
        ...
        return (
            <div key={index}
                ...
                {(!head && selected) && <div className={styles.checkedItem}></div>}
            </div>
        );
    };
...
export default onClickOutside(LangModDropDownList);
