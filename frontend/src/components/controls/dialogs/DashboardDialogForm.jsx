...
import styles from './DashboardDialogForm.scss';


export default class DashboardDialogForm extends Component {
    static propTypes = {
    ...
    render() {
        ...
        const className = classNames(styles.dialog, dialogClassName);
        return (
            <ReactModal
                isOpen={visible}
                ariaHideApp={false}
